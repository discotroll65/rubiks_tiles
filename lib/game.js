(function(){
  ...
  Game.prototype.xAxisRotate = function(){
    ...
    oldCenter.reassignWindowPlace("bottomStart");
    oldTop.reassignWindowPlace("centerStart");
    oldBack.reassignWindowPlace("topStart");
    oldBack.moveRotate().moveRotate();
    oldBottom.reassignWindowPlace("backStart");
