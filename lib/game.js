(function(){
  ...
  Game.prototype.axisRotate = function(opts){
    ...
    (opts.positive) ? opts.negInvSpinFace.moveRotate() : opts.negInvSpinFace.moveRotateI();
    (opts.positive) ? opts.posInvSpinFace.moveRotateI() : opts.posInvSpinFace.moveRotate();
    this.draw(this.ctx);
  };
